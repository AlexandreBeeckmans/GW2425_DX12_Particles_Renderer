...
DirectX::XMMATRIX Camera::get_ViewProjectionMatrix() const
{
    return pData->m_ViewProjectionMatrix;
}
...
void Camera::UpdateViewMatrix() const
{
    ...
    pData->m_ViewProjectionMatrix = pData->m_ViewMatrix * pData->m_ProjectionMatrix;
}
